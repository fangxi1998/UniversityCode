/**************************************************************************************************
Filename:       sapi.c
Revised:        $Date: 2009-03-18 15:53:27 -0700 (Wed, 18 Mar 2009) $
Revision:       $Revision: 19452 $
...
UINT16 SAPI_ProcessEvent( byte task_id, UINT16 events )
{
    ...
    if ( events & ZB_ENTRY_EVENT )
    {
        ...
        {
            zb_StartRequest();//再次启动设备，建立/加入网络
        }
        else
        {
