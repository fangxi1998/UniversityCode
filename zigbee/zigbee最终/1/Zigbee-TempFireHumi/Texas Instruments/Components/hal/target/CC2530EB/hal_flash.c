...
#elif defined HAL_OAD_BOOT_CODE // OAD boot code does not use RAM copy
#define OSET_OF_RAM_CODE  0x7E5
#define PAGE_OF_RAM_CODE  0
#define SIZE_OF_RAM_CODE  0x1B
#else                   // Z-Stack is using 0x39DDD --> pg 51, offset 0x5DD.
#define OSET_OF_RAM_CODE  0x5DD
